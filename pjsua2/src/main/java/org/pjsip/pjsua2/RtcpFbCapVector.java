...
public class RtcpFbCapVector extends java.util.AbstractList<RtcpFbCap> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(RtcpFbCapVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return pjsua2JNI.RtcpFbCapVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    pjsua2JNI.RtcpFbCapVector_doReserve(swigCPtr, this, n);
  }
