...
public class AudioDevInfoVector2 extends java.util.AbstractList<AudioDevInfo> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(AudioDevInfoVector2 obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return pjsua2JNI.AudioDevInfoVector2_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    pjsua2JNI.AudioDevInfoVector2_doReserve(swigCPtr, this, n);
  }
