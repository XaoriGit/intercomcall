...
public class MediaFormatAudioVector extends java.util.AbstractList<MediaFormatAudio> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(MediaFormatAudioVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return pjsua2JNI.MediaFormatAudioVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    pjsua2JNI.MediaFormatAudioVector_doReserve(swigCPtr, this, n);
  }
