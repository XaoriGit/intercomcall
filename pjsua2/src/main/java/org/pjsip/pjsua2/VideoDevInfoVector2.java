...
public class VideoDevInfoVector2 extends java.util.AbstractList<VideoDevInfo> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(VideoDevInfoVector2 obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return pjsua2JNI.VideoDevInfoVector2_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    pjsua2JNI.VideoDevInfoVector2_doReserve(swigCPtr, this, n);
  }
