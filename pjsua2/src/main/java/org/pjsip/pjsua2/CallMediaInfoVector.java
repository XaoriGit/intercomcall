...
public class CallMediaInfoVector extends java.util.AbstractList<CallMediaInfo> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(CallMediaInfoVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return pjsua2JNI.CallMediaInfoVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    pjsua2JNI.CallMediaInfoVector_doReserve(swigCPtr, this, n);
  }
