...
public class VideoMediaVector extends java.util.AbstractList<VideoMedia> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(VideoMediaVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return pjsua2JNI.VideoMediaVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    pjsua2JNI.VideoMediaVector_doReserve(swigCPtr, this, n);
  }
