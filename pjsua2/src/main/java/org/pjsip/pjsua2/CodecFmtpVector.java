...
public class CodecFmtpVector extends java.util.AbstractList<CodecFmtp> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(CodecFmtpVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return pjsua2JNI.CodecFmtpVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    pjsua2JNI.CodecFmtpVector_doReserve(swigCPtr, this, n);
  }
