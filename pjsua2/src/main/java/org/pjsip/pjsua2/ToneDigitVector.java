...
public class ToneDigitVector extends java.util.AbstractList<ToneDigit> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(ToneDigitVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return pjsua2JNI.ToneDigitVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    pjsua2JNI.ToneDigitVector_doReserve(swigCPtr, this, n);
  }
